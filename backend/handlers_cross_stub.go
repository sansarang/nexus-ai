...
6. 분량 — 단순 질문 1-3문장, 복잡한 질문 5-8문장.
7. 마크다운 헤더 금지 — 굵게(**) 정도만.
8. "물론입니다", "당연히" 같은 빈말 금지.
9. 모르면 "확실하지 않음" 명시.
`

func getPersonaSystemPrompt() string { return getActivePersona().SystemPrompt + personaQualityGuide }

// detectPersonaForQuery — 쿼리 분석해서 최적 페르소나 자동 추천
// (Mac stub: handlers_persona.go의 windows 버전과 동일 키워드 매핑)
func detectPersonaForQuery(msg string) string {
	...
	mappings := []struct {
		...
		{"developer", []string{"코드", "디버그", "버그", "리팩토링", "함수", "클래스", "메서드", "git ", "github", "python", "typescript", "javascript", "react", "go ", "golang", "rust", "java", "api ", "sql", "docker", "kubernetes", "code review", "refactor", "debug"}},
		{"security", []string{"보안", "취약점", "해킹", "악성코드", "랜섬웨어", "피싱", "cve", "owasp", "mitre", "att&ck", "침해", "security", "vulnerability", "malware", "exploit"}},
		{"legal", []string{"계약서", "계약", "약관", "조항", "독소조항", "법률", "법령", "판례", "nda", "compliance", "gdpr", "개인정보보호", "저작권", "특허", "contract", "agreement", "legal", "lawsuit", "patent"}},
		{"medical", []string{"증상", "병", "약", "처방", "복용", "부작용", "임상", "논문", "진단", "치료", "당뇨", "고혈압", "암", "pubmed", "clinical", "diagnosis", "treatment", "drug", "symptom"}},
		{"investor", []string{"주식", "주가", "종목", "코인", "비트코인", "etf", "펀드", "포트폴리오", "배당", "재무제표", "per", "pbr", "roe", "매수", "매도", "공매도", "환율", "stock", "ticker", "earnings", "dividend", "crypto"}},
		{"finance", []string{"예산", "비용", "지출", "수입", "매출", "원가", "회계", "결산", "roi", "irr", "npv", "ebitda", "budget", "expense", "revenue", "accounting"}},
		{"marketer", []string{"마케팅", "광고", "캠페인", "카피", "후크", "타겟", "퍼널", "전환", "리텐션", "ltv", "sns", "인스타", "유튜브", "틱톡", "릴스", "바이럴", "ctr", "cvr", "roas", "marketing", "advertising", "campaign", "viral"}},
		{"sales", []string{"영업", "세일즈", "리드", "콜드메일", "콜드콜", "제안서", "견적서", "클로징", "협상", "spin", "bant", "meddic", "crm", "sales", "lead", "pitch", "proposal", "negotiation"}},
		{"pm", []string{"prd", "기획서", "스프린트", "백로그", "user story", "유저 스토리", "로드맵", "마일스톤", "okr", "kpi", "rice", "ice scoring", "product manager", "scrum", "애자일", "jira", "우선순위"}},
		{"designer", []string{"ui", "ux", "디자인", "와이어프레임", "프로토타입", "피그마", "figma", "타이포", "폰트", "컬러", "팔레트", "디자인 시스템", "material design", "wcag", "design system", "wireframe", "mockup"}},
		{"meeting", []string{"회의", "미팅", "회의록", "안건", "agenda", "minutes", "참석자", "meeting", "회의 잡"}},
		{"research", []string{"경쟁사", "시장 조사", "리서치", "벤치마킹", "트렌드 분석", "산업 분석", "백서", "whitepaper", "competitor analysis", "market research"}},
		{"creative", []string{"아이디어", "브레인스토밍", "컨셉", "네이밍", "슬로건", "스토리텔링", "brainstorm", "creative", "concept", "naming"}},
		{"freelancer", []string{"프리랜서", "외주", "프로젝트 견적", "수임료", "원천세", "종합소득세", "사업소득", "freelance", "invoicing"}},
		{"smallbiz", []string{"소상공인", "자영업", "카페", "음식점", "매장 운영", "부가세", "사업자등록", "임대료", "small business"}},
		{"corporate", []string{"법인", "법인세", "주주", "이사회", "정관", "감사", "결산공시", "4대보험", "전자세금계산서", "급여대장", "원천징수", "corporate", "shareholder"}},
		{"creator", []string{"유튜브 스크립트", "콘텐츠 제작", "썸네일", "구독자", "조회수", "수익화", "youtube creator", "tiktok creator", "monetization"}},
		{"tutor", []string{"공부", "학습", "문제 풀이", "수학", "영어 회화", "과외", "강의", "튜터", "학생", "시험", "수능", "토익", "토플", "ielts", "tutoring", "lesson", "homework", "exam"}},
	}
