...
"web_search" → 쇼핑/최저가/뉴스/가격비교/쿠팡/네이버/유튜브/틱톡/테무/검색/버스/기차/지하철/교통/여행/맛집/식당/날씨/환율/주가/병원/약국/영화/공연/예약/길찾기/요금/시간표/노선/운임/경로/이동
  예) "쿠팡에서 에어팟 찾아줘" "네이버 AI 뉴스 10개" "삼성 노트북 최저가"
  예) "유튜브에서 요리 영상 찾아줘" "틱톡에서 댄스 영상" "테무에서 저렴한 이어폰"
  예) "부산터미널에서 인천 청라 가는 버스" "서울역 부산 KTX 시간표" "강남 맛집 추천"
  예) "오늘 달러 환율" "삼성전자 주가" "가까운 응급실 위치" "CGV 영화 시간표"
  params: {"query":"검색어","site":"coupang|naver|youtube|tiktok|temu|danawa|gmarket|11st|google|auto","max_items":5,"output":"pdf|excel|text"}
