...
const FOLLOW_UP_MAP_KO: Record<string, Array<{ label: string; cmd: string }>> = {
  ...
  pc_status:        [{ label: '🛠️ 문제 수리', cmd: '문제 수리해줘' }, { label: '🧹 정리하기', cmd: '캐시랑 임시파일 정리해줘' }, { label: '📊 상세 리포트', cmd: 'PC 건강 리포트 보여줘' }],
  stats:            [{ label: '🛠️ 문제 수리', cmd: '문제 수리해줘' }, { label: '🧹 정리하기', cmd: '캐시랑 임시파일 정리해줘' }, { label: '📊 상세 리포트', cmd: 'PC 건강 리포트 보여줘' }],
  scan:             [{ label: '🔧 문제 수리', cmd: '발견된 문제 수리해줘' }, { label: '📊 PC 상태', cmd: 'PC 상태 보여줘' }],
...
const FOLLOW_UP_MAP_EN: Record<string, Array<{ label: string; cmd: string }>> = {
  ...
  pc_status:        [{ label: '🛠️ Fix Issues', cmd: 'Fix the problems' }, { label: '🧹 Clean Up', cmd: 'Clean cache and temp files' }, { label: '📊 Health Report', cmd: 'Show PC health report' }],
  stats:            [{ label: '🛠️ Fix Issues', cmd: 'Fix the problems' }, { label: '🧹 Clean Up', cmd: 'Clean cache and temp files' }, { label: '📊 Health Report', cmd: 'Show PC health report' }],
  scan:             [{ label: '🔧 Fix Issues', cmd: 'Fix detected issues' }, { label: '📊 PC Status', cmd: 'Show PC status' }],
