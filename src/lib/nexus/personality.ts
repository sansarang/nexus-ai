const PERSONA_GREETINGS: Record<string, string[]> = {
  ...
  smallbiz: [
    '사업자번호 조회, 배달앱 수수료 확인, 지원정책 검색 — 바로 도와드릴게요! 🏪',
    '오늘 매장 운영에 필요한 게 있나요? 배달앱 노출 전략부터 원가 계산까지 가능해요.',
    '소상공인 지원정책, 카드수수료 환급, 공지사항 — 놓치지 않게 챙겨드릴게요.',
  ],
  corporate: [
    '법인세 일정, 세금계산서, 4대보험 — 법인 업무 전반 도와드릴게요! 🏢',
    '이번 달 법인 세무 일정 확인해드릴까요? 부가세·법인세 마감일 바로 조회 가능해요.',
    '전자세금계산서 발행·수취 현황, 4대보험 공제액 계산, 계약서 검토 다 됩니다.',
  ],
}
